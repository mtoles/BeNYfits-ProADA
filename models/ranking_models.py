...
if __name__ == "__main__":
    ...
    ordered_cq = clarifying_answers_ranking_model.forward(doc_summ=doc_summ,
                                                          task=task,
                                                          cq=cq,
                                                          ca=ca)
    ...
    primary_model_output_ranking_model = GPTPrimaryModelOutputRankingModel(use_cache=True)

    ordered_cq = primary_model_output_ranking_model.forward(doc_summ=doc_summ,
                                                            task=task,
                                                            cq=cq,
